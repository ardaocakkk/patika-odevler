...
public class ProductActions
{
    ...
    public void addAProduct(HashMap<Integer,ProductManager> ourProductList)
    {
        ...
        ProductManager newProduct=new ProductManager(productName,ourBrand,screenSize,bataryPower,memory,ram,color,price,quality,discountRate);
        ourProductList.put(newProduct.getId(),newProduct);


    }
    public void deleteToProduct(HashMap<Integer,ProductManager> ourProductList)
    {
    ...
    public void listToProducts(HashMap<Integer,ProductManager> ourProductList)
    {
        ...
        System.out.format("+----------+--------------------------------+------------------------+--------------+------------------------+---------------------------+------------------+------------------------+------------------------+------------------+------------------------+\n");
        for (ProductManager product:ourProductList.values())
        {
    ...
    public void searchByFilter(HashMap<Integer,ProductManager> ourProductList)
    {
        ...
        if (filter.matches("\\d+"))
        {
            ...
            {
                ProductManager product=ourProductList.get(ourFilter);
                String format = "| %-8s | %-30s | %-22s | %-12s | %-22s | %-25s | %-16s | %-22s | %-22s | %-16s | %-22s |\n";
                System.out.format("+----------+--------------------------------+------------------------+--------------+------------------------+---------------------------+------------------+------------------------+------------------------+------------------+------------------------+\n");
                System.out.format("| ID       | Ürün Adı                       | Marka                  | Ekran Boyutu | Batarya Kapasitesi     | Depolama Kapasitesi       | RAM Kapasitesi   | Renk                   | Fiyat                  | Adet             | İndirim Oranı          |\n");
                System.out.format("+----------+--------------------------------+------------------------+--------------+------------------------+---------------------------+------------------+------------------------+------------------------+------------------+------------------------+\n");
